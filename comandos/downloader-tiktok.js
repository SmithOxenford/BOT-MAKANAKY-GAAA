...
try {
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: 'MAKANAKY-BOT-GAAA', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/SmithOxenford/MAKANAKY-BOT-GAAA' }, mentionedJid: [m.sender] }}}, { quoted: m })
